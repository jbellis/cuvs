...
EXAMPLES_C_BUILD_DIR=${REPODIR}/examples/c/build
EXAMPLES_CPP_BUILD_DIR=${REPODIR}/examples/c/build
BUILD_DIRS="${LIBCUVS_BUILD_DIR} ${PYTHON_BUILD_DIR} ${RUST_BUILD_DIR} ${EXAMPLES_C_BUILD_DIR} ${EXAMPLES_CPP_BUILD_DIR}"
